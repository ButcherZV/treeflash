...
{
    currentTree = -1;
    a_alltree_status = Array(0, 0, 0);
    a_tree00_ppl_status = Array(0, 0, 0);
    a_tree01_ppl_status = Array(0, 0, 0);
    a_tree02_ppl_status = Array(0, 0, 0);
    a_tree00_ani_status = Array(-1, -1, -1);
    a_tree01_ani_status = Array(-1, -1, -1);
    a_tree02_ani_status = Array(-1, -1, -1);
    animating = 0;
    a_pplName = Array("man01", "woman01", "woman02");
    pplOffset = 5;
    a_man01_loc = Array(82.500000 + pplOffset, 280, 239.500000, 280, 394.500000 - pplOffset, 280, "", "", 247.500000, 280);
    a_woman01_loc = Array(147 + pplOffset, 292, 304, 292, 459 - pplOffset, 292, "", "", 312, 292);
    a_woman02_loc = Array(218 + pplOffset, 278, 375, 278, 530 - pplOffset, 278, "", "", 383, 278);
    flag_grow = 0;
    currentLeave = -1;
    flag_pplButActive = 0;
    ...
    for (i = 0; i < 3; i++)
    {
        _root[a_pplName[i]]._x = _root["a_" + a_pplName[i] + "_loc"][8];
        _root[a_pplName[i]]._y = _root["a_" + a_pplName[i] + "_loc"][9];
    } // end of for
    refresh_ppl_status();
    visibleSeedClickMe();
    invisiblePplClickMe();
} // End of the function
reset_but.onRollOver = function ()
{
    if (_root.flag_pplButActive == 0)
    {
...
reset_but.onRollOut = reset_but.onDragOut = function ()
{
    this.gotoAndStop(1);
};
reset_but.onRelease = function ()
{
    if (_root.flag_pplButActive == 1)
    {
        reset();
        this.gotoAndStop(1);
    } // end if
